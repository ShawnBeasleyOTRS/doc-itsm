...
latex_documents = [
    (master_doc, 'doc-itsm.tex', 'OTRS::ITSM Documentation',
     'OTRS AG', 'manual'),
]
...
texinfo_documents = [
    (master_doc, 'doc-itsm', 'OTRS::ITSM Documentation',
     author, 'doc-itsm', 'Admin manual for OTRS::ITSM.',
     'Miscellaneous'),
]
