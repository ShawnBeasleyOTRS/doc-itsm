...
.. note::
   ...
   In order to grant users access to the *CMDB* menu, you need to add them as member to the group *itsm-configitem*.
...
.. warning::
   ...
   The group *itsm-configitem* that was created during package installation will be deactivated. You can activate this group again in the administrator interface.

   All links to configuration item objects **will be irrevocably deleted**!
